...
**Project**: friendly-landing-garden 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a landing page website  
...
```sh
git clone https://github.com/GPT-Engineer-App/friendly-landing-garden.git
cd friendly-landing-garden
npm i
